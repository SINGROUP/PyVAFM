...
inter.Configure(ForceMultiplier=0.00166) # the values here are KJ/mol/nm. this factor brings them to nN
...
out1.Register('global.time',"scan.x" ,'canti.zabs','amp.amp','agc.out',"pll.df")


#Imaging output
imager = machine.AddCircuit(type='output',name='image',file='Image.dat', dump=0)

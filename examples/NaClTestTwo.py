...
canti = machine.AddCircuit(type='Cantilever',name='canti', startingz=1,Q=10000, k=167.0, f0=150000, pushed=True)
...
out2.Register('global.time', 'canti.ztip','agc.out','pll.df',"canti.fz","scan.z","inter.F3")
out2.Stop()
...
scanner.Place(x=0.705,y=0.705,z=15)
machine.Wait(0.1)   
out2.Start()
#scanner.Move(x=0,y=0,z=-11)
#machine.Wait(0.1)

#scanner.Move(x=0,y=0,z=10)

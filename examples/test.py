...
# wave generator
machine.AddCircuit(type='waver', name='wave', amp=1,
                   freq=2, phi=1, offset=2.0, pushed=True)
machine.AddCircuit(type='square', name='sqw', amp=1.5,
                   freq=2, offset=0.0, duty=0.2, pushed=True)
...
out1 = machine.AddCircuit(type='output', name='output',
                          file='wavers.log', dump=1)
out1.Register('global.time', 'wave.sin', 'wave.cos',
              'wave.saw', 'sqw.out', "Add.out")

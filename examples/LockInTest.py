...
machine.AddCircuit(type="Machine", name='LockInAmp', intTime=1.0/f0 *
                   1000, CentFreq=f0, gain=1, Ampgain=2, assembly=LockInAmp, pushed=True)

...
def main():
    ...
    machine.AddCircuit(type='VDW', name='VDW', alpha=0.28658,
                       hamaker=39.6e-20, radius=3.9487, offset=0, pushed=True)
    ...
    # xe-Kr
    # dimer
    machine.AddCircuit(type='VDWtorn', name='Dimer', A1=0.263191, A2=0.527478,
                       A3=-1259.79, A4=23749.8, A5=-88463.2, A6=-4.00773, tipoffset=0, pushed=True)

    # Surface
    machine.AddCircuit(type='VDWtorn', name='Pyramid', A1=-1925.32, A2=635.529,
                       A3=-1160.23, A4=22763.2, A5=-101664., A6=1.99542, tipoffset=0, pushed=True)

    # Pyramid
    machine.AddCircuit(type='VDWtorn', name='Surface', A1=-891.534, A2=416.779,
                       A3=1558.35, A4=-8353.84, A5=15269.4, A6=-84.7053, tipoffset=0, pushed=True)
    ...
    out1 = machine.AddCircuit(
        type='output', name='output', file='VDW.dat', dump=1)
    out1.Register("scan.z", "global.time", "VDW.fz",
                  "Dimer.fz", "Surface.fz", "Pyramid.fz")

    machine.Connect("scan.z", "VDW.ztip", "Dimer.ztip",
                    "Surface.ztip", "Pyramid.ztip")

...
# Outputs
    out1 = machine.AddCircuit(
        type='output', name='output', file='testafm.out', dump=10000)
    ...
    out2 = machine.AddCircuit(
        type='output', name='output2', file='testafm2.out', dump=1000)
    out2.Register('global.time', 'canti.ztip',
                  'agc.out', "canti.fz", "amp.amp")
    out2.Stop()

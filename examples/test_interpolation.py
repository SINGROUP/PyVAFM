...
def main():
        ...
        scan = machine.AddCircuit(type='scanner',name='scann', Process = machine, pushed=False)
        inter = machine.AddCircuit(type='Interpolate',name='inter', Filename = 'test_interpolation.dat', Dimensions = 3, Components = 3 ,pushed=False)
	...
	machine.Connect("scann.pos" , "inter.coord")
        ...
        #Outputs
        out1 = machine.AddCircuit(type='output',name='output',file='test_interpolation.log', dump=1)

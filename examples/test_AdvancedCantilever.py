...
def main():
	...
	#Add Circuits
	canti = machine.AddCircuit(type='AdvancedCantilever',name='canti',NumberOfModesV=1,NumberOfModesL=0, pushed=True)

	canti.AddK(1.1,2.2,3.3)
	canti.AddQ(1.2,2.3,3.4)
	canti.AddM(1.3,2.4,2.5)
	canti.Addf0(1.4,2.5,2.6)

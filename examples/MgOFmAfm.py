...
def main():
	...
	inter.Configure(steps=[0.254375,0.254375,0.5], npoints=[32,32,8])
	inter.Configure(pbc=[True,True,False])
	inter.Configure(ForceMultiplier=1.60217646)
	inter.ReadData('forces_mg.in')



	#Imaging output
	imager = machine.AddCircuit(type='output',name='image',file='MgO.dat', dump=0)
	...
	scanner.Place(x=0.254375,y=0.254375,z=3)

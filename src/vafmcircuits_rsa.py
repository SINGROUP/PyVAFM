...
class RSA(Circuit):
    ...
    def __init__(self, machine, name, **keys):
        ...
        Circuit.cCore.RSA_SetMasses.argtypes = [
            c_int, c_double, c_double, c_double]
        Circuit.cCore.RSA_SetGammas.argtypes = [
            c_int, c_double, c_double, c_double]
        Circuit.cCore.RSA_SetPoints.argtypes = [
            c_int, c_double, c_double, c_double]
        Circuit.cCore.RSA_SetSprings.argtypes = [
            c_int, c_double, c_double, c_double]
    ...
    def _SetSprings(self):
        Circuit.cCore.RSA_SetSprings(
            self.cCoreID, self.springs[0], self.springs[1], self.springs[2])
    ...
    def _SetPoints(self):
        Circuit.cCore.RSA_SetPoints(
            self.cCoreID, self.points[0], self.points[1], self.points[2])
    ...
    def _SetGammas(self):
        Circuit.cCore.RSA_SetGammas(
            self.cCoreID, self.gammas[0], self.gammas[1], self.gammas[2])
    ...
    def _SetMasses(self):
        Circuit.cCore.RSA_SetMasses(
            self.cCoreID, self.masses[0], self.masses[1], self.masses[2])

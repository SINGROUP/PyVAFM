...
class output(Circuit):
    ...
    def __init__(self, machine, name, **keys):
        ...
        self.cCoreID = Circuit.cCore.Add_output(
            self.machine.cCoreID, self.filename, c_int(self.dump))
    ...
    def Register(self, *args):
        ...
        for ch in cclist:
            print('PY: registering channel:',
                  ch.owner.cCoreID, ch.cCoreCHID, ch.cisInput)

            Circuit.cCore.output_register(
                self.cCoreID, ch.owner.cCoreID, ch.cCoreCHID, ch.cisInput)
    ...
    def Update(self):
        ...
        # check if the record signal is connected to something else

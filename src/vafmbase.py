...
class Channel(object):
    ...
    def value_set(self, value):
        ...
        Circuit.cCore.PyToChannel(
            self.owner.cCoreID, self.cCoreCHID, self.cisInput, c_double(value))
...
class Circuit(object):
    ...
    def SetInputs_fromKeys(self, **kwargs):
        ...
        for key in list(kwargs.keys()):
            ...
            if key in list(self.I.keys()):
                ...
                print("PY: "+key+" is an input channel, calling cCore:",
    ...
    def AddInput(self, name):
        ...
        if name in list(self.I.keys()) or name in list(self.O.keys()):
            raise NameError("A channel named "+name +
                            " already exists in circuit " + str(self))
    ...
    def GetChannel(self, chname):
        ...
        if not(isout or isin):
            raise NameError(
                "Circuit.GetChannel error: channel "+chname+" not found.")
    ...
    def GetOutputChannel(self, chname):
        ...
        if not(isout or isin):
            raise NameError(
                "Circuit.GetOutputChannel error: channel "+chname+" not found.")

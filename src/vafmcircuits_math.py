...
class opAdd(Circuit):
    ...
    def __init__(self, machine, name, **keys):
        ...
        self.cCoreID = Circuit.cCore.Add_Math(
            self.machine.cCoreID, "opADD", self.factors)
...
class opMul(Circuit):
    ...
    def __init__(self, machine, name, **keys):
        ...
        self.cCoreID = Circuit.cCore.Add_Math(
            self.machine.cCoreID, "opMUL", self.factors)
...
class opLinC(Circuit):
    ...
    def __init__(self, machine, name, **keys):
        ...
        self.cCoreID = Circuit.cCore.Add_Math(
            self.machine.cCoreID, "opLINC", self.factors*2)
...
class ComplexMagAndPhase(Circuit):
    ...
    def __init__(self, machine, name, **keys):
        ...
        self.cCoreID = Circuit.cCore.Add_ComplexMagAndPhase(

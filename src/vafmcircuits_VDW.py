...
class VDW(Circuit):
    ...
    def __init__(self, machine, name, **keys):
        ...
        self.cCoreID = Circuit.cCore.Add_VDW(
            self.machine.cCoreID, alpha, hamaker, radius, offset)
...
class VDWtorn(Circuit):
    ...
    def __init__(self, machine, name, **keys):
        ...
        self.cCoreID = Circuit.cCore.Add_VDWtorn(
            self.machine.cCoreID, A1, A2, A3, A4, A5, A6, tipoffset)
